			...
			<main className="flex-grow">
				<section className="relative py-12 md:py-24 overflow-hidden">
					...
					<div className="container mx-auto px-4 relative z-10">
						...
						<p className="text-base md:text-xl text-gray-300 text-center max-w-3xl mx-auto mb-8 md:mb-16">
							Hast du Interesse an einer individuellen Mystery Box oder andere Fragen? Wir sind hier, um dir zu helfen!
						</p>

						<div className="max-w-2xl mx-auto">
							<div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 border border-gray-800">
								<form className="space-y-4 md:space-y-6">
									<div>
										...
										<input
											...
											id="name"
											required
											className="w-full px-4 py-3 rounded-xl border border-gray-700 bg-gray-800/50 text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors placeholder-gray-500"
											placeholder="Dein Name"
										/>
									</div>
									<div>
										<label htmlFor="subject" className="block text-sm font-medium text-gray-300 mb-2">Betreff</label>
										<select
											id="subject"
											required
											className="w-full px-4 py-3 rounded-xl border border-gray-700 bg-gray-800/50 text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors placeholder-gray-500"
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-12">
								<div className="bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-800 hover:border-indigo-500/50 transition-all duration-300">
									...
									<p className="mt-6 text-gray-300 text-center font-medium tracking-wide hover:text-indigo-400 transition-colors duration-300">support@mysterybox.de</p>
								</div>
								<div className="bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-800 hover:border-indigo-500/50 transition-all duration-300">
									...
									<p className="mt-6 text-gray-300 text-center font-medium tracking-wide hover:text-indigo-400 transition-colors duration-300">+49 (0) 123 456789</p>
								</div>
							</div>
