						...
						<ul className="space-y-3">
							<li>
								<a href="https://www.tiktok.com/@simo4287/"
									...
									<span className="w-6 h-6 flex items-center justify-center rounded-full bg-gray-800 group-hover:bg-gray-700 transition-colors duration-200">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
					<div className="flex flex-col md:flex-row items-center justify-between gap-4">
						...
						<div className="flex items-center gap-2 text-sm text-gray-400">
							...
							<Heart className="w-2.5 h-2.5 text-pink-500 animate-pulse" />
							<span>&</span>
